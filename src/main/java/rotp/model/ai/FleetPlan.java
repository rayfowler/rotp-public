...
public class FleetPlan implements Base, Serializable {
    ...
    public static final int BOMB_ENCROACHMENT = 950;
    public static final int GUARD_ATTACK_TARGET = 900;
    public static final int EXPEL = 800;
    public static final int BOMB_UNDEFENDED = 750;
    public static final int SCOUT_TO_UNEXPLORED = 600;
    public static final int COLONIZE = 500;
