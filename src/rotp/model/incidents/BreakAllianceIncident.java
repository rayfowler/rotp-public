...
public class BreakAllianceIncident extends DiplomaticIncident {
    ...
    final int empMe;
    public static BreakAllianceIncident create(Empire e1, Empire e2) {
        BreakAllianceIncident inc = new BreakAllianceIncident(e1, e2);
        return inc;
    }
    private BreakAllianceIncident(Empire e1, Empire e2) {
        empBreaker = e1.id;
        empMe = e2.id;
        severity = -30;
