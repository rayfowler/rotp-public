...
public class ShipFighterTemplateC implements Base {
    private static final List<DesignDamageSpec> dmgSpecs = new ArrayList<>();
    private static final ShipFighterTemplateC instance = new ShipFighterTemplateC();
    ...
    private ShipDesign newDesign(ShipDesigner ai, int size, List<EnemyShipTarget> targets) {
        ...
        if (d.size() >= ShipDesign.SMALL) // change from MEDIUM to SMALL for best armor
