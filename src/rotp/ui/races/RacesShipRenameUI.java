...
public final class RacesShipRenameUI extends BasePanel implements MouseListener, MouseMotionListener {
    private static final long serialVersionUID = 1L;
    private static final Color backgroundHaze = new Color(0,0,0,160);

    private static final int DIALOG_W = 310;
    private static final int DIALOG_H = 325;
    ...
    public void paintComponent(Graphics g0) {
        ...
        g.setStroke(prevStr);
        String str = text("SHIP_DESIGN_RENAME_OK");
